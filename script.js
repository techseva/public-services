...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function renderUpdatesUI(updates) {
        // Try to find a dedicated dynamic container first
        let list = document.getElementById('dynamic-updates');

        // If not found, fall back to the main container (backward compatibility)
        if (!list) {
    ...
    function renderServicesUI(services, contextId) {
        // Try to find a dedicated dynamic container first
        let list = document.getElementById('dynamic-services');

        // If not found, fall back to the main container (e.g. for page.html)
        if (!list) {
            list = document.querySelector('#services');
        }
